...
const CONTRACT_ADDRESS = "0xB1c667bE4FC519701D82A3b4262F626B941b065e";
...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const newMessage = "Hello greeter2222!";
  const tx2 = await contract.createGreeter();

  console.log(`Transaction to create a new greeter is ${tx2.hash}`);
  await tx2.wait();
  ...
  console.log(`The list of greeters is ${await contract.getList()}`);
